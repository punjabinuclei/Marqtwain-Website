...
const ContactForm = () => {
    ...
    const handleSubmit = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        const { name, email, message, phone, button } = contactData;
        ...
        try {
            const res = await fetch("https://marqtwinn-website-default-rtdb.firebaseio.com/Contact.json", {
                method: 'POST',
                headers: {
                ...
                <div className="hidden lg:block">
                    <form action="">
                        ...
                        <div id="contact-form-buttons">
                            <div className='flex'>
                                <div className={`mr-2 ${activeButton === 'user-research' ? 'activeButton' : ''}`}>
                                    <button
